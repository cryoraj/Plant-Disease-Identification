...
**Class Distribution:** Highly imbalanced (CV=88.99%)
...
**Common characteristics of best performers:**
...
**Common characteristics of worst performers:**
...
**1. Same-plant disease confusion (65% of top errors):**
...
**Pattern indicates:** Model learns plant species identification well but struggles with disease-specific features on the same plant, particularly for tomato which dominates the training data.

**2. Tomato bacterial spot over-prediction (57 false positives):**
...
**3. High-impact single confusions:**
...
**4. Bidirectional confusion patterns indicate genuine uncertainty:**
...
**5. Cross-plant confusions minimal:**
...
├── notebooks/
│   └── best_model_Baseline.h5      # Trained baseline model
│   └── plant_disease_eda_baseline.ipynb  # Main analysis notebook with EDA + baseline model
├── PlantVillageData/
│   └── color/                 
│       ├── Apple___Apple_scab/
│       ├── Tomato___Early_blight/
│       └── ... (38 total class folders)
├── UNDERSTANDING_THE_DATA.md         # Comprehensive dataset documentation
